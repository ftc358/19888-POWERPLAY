...
public class SleeveDetection extends OpenCvPipeline {
    ...
    private static Point SLEEVE_TOPLEFT_ANCHOR_POINT = new Point(110, 185);
    ...
    private static final Scalar
            lower_yellow_bounds  = new Scalar(180, 180, 0, 255),
            upper_yellow_bounds  = new Scalar(255, 255, 100, 255),

            lower_cyan_bounds    = new Scalar(0, 84, 84, 255),
            upper_cyan_bounds    = new Scalar(150, 255, 255, 255),

            lower_magenta_bounds = new Scalar(60, 0, 60, 255),
